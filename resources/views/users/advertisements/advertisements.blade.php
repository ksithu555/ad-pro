      ...
      <div class="container">
        <div class="row">
            <div class="col-sm-8 section-heading">
                <form id="search-form" action="{{ route('user.get.advertisements') }}" method="GET">
                    ...
                    <table class="table table-bordered table-striped table-hover shop-cart">
                        ...
                        <tbody>
                            ...
                            <div id="modal-popup-{{ $advertisement->id }}" class="white-bg all-padding-60 mfp-with-anim mfp-hide centerize-col col-lg-4 col-md-6 col-sm-7 col-xs-11 text-center">
                                ...
                                <a class="btn btn-lg btn-circle btn-color" href="{{ route('user.delete.advertisement', $advertisement->id) }}">はい</a>
