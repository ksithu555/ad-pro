<x-user-layout>
    ...
    <div class="container">
    	<div class="row">
        	<div class="col-sm-8 section-heading">
              <h4 class="text-uppercase mt-0">動画ブロック登録</h4>
        	</div>
        </div>
        <div class="row mt-50">
            <div class="col-md-8 col-md-offset-2">
                <form name="add-video-block-form" id="add-video-block-form" action="{{ route('user.store.video.block') }}" method="POST" 
  ...
  <div id="modal-popup" class="white-bg all-padding-60 mfp-with-anim mfp-hide centerize-col col-lg-4 col-md-6 col-sm-7 col-xs-11 text-center">
    <span class="text-uppercase font-30px font-600 mb-20 display-block dark-color">動画ブロック登録</span>
    <p class="mb-20">動画ブロックを登録してもよろしいですか?</p>
    ...
    <script>
        ...
        function submitForm() {
            ...
            document.getElementById('add-video-block-form').submit();
        }
