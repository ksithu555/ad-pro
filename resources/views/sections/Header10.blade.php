<x-section-layout>
            ...
            <div id="rev_slider_347_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.3">
                <ul>	<!-- SLIDE  -->
                    <li data-index="rs-967" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img src="{{ asset('assets/images/transparent.png') }}" data-bgcolor='linear-gradient(45deg, rgba(63,13,60,1) 0%, rgba(63,13,60,1) 100%)' style='background:linear-gradient(45deg, rgba(63,13,60,1) 0%, rgba(63,13,60,1) 100%)' alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption   tp-resizeme"
                            ...
                            style="z-index: 5;">
                            <img src="{{ asset('assets/images/object/OBJ_triangle_fix.png') }}" alt="" data-ww="['55px','55px','55px','56px']" data-hh="48px" width="111" height="96" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-1"
                            ...
                            style="z-index: 6;">
                            <img src="{{ asset('assets/images/object/OBJ_eraser_color.png') }}" alt="" data-ww="['530px','530px','300px','265px']" data-hh="['60px','60px','34px','30px']" width="530" height="60" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-shape tp-shapewrapper  tp-resizeme"
                            ...
                            style="z-index: 9;background-color:rgb(191,7,49);">
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-1"
                            ...
                            style="z-index: 10;">
                            <img src="{{ asset('assets/images/object/OBJ_eraser_color.png') }}" alt="" data-ww="['300px','300px','150px','150px']" data-hh="['400px','400px','200','200px']" width="300" height="400" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-1"
                            ...
                            style="z-index: 11;">
                            <img src="{{ asset('assets/images/object/OBJ_eraser.png') }}" alt="" data-ww="['230px','230px','20%','165px']" data-hh="['130px','130px','130px','93px']" width="230" height="130" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption tp-shape tp-shapewrapper  tp-resizeme rs-parallaxlevel-2"
                            ...
                            <img id="imageFile967" src="{{ asset('assets/images/title-bg/ad-pro-default.jpg') }}" alt="" data-ww="['660px','660px','520px','360px']" data-hh="['560px','560px','460px','460px']" width="710" height="630" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-2"
                            ...
                            style="z-index: 13; white-space: nowrap; font-size: 100px; line-height: 100px; font-weight: 600; color: #ffffff; letter-spacing: 30px;font-family:Poppins;">
                            ADPRO
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-2"
                            ...
                            style="z-index: 14; white-space: nowrap; font-size: 100px; line-height: 100px; font-weight: 600; color: #ffffff; letter-spacing: 30px;font-family:Poppins;">
                            NO CODING REQUIRED<br>TO BUILT YOUR PAGE
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-4"
                            ...
                            style="z-index: 17;">
                            <img src="{{ asset('assets/images/object/OBJ_eraser_color.png') }}" alt="" data-ww="['710px','710px','400px','355px']" data-hh="['630px','630px','355px','315px']" width="710" height="630" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-3"
                            ...
                            style="z-index: 20;">
                            <img src="{{ asset('assets/images/object/OBJ_eraser_color.png') }}" alt="" data-ww="['320px','320px','200px','160px']" data-hh="['450px','450px','281px','225px']" width="320" height="450" data-no-retina>
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-12"
                            ...
                            <img src="{{ asset('assets/images/object/OBJ_triangle.png') }}" alt="" data-ww="['110px','110px','110px','110px']" data-hh="['95px','95px','95px','95px']" width="221" height="191" data-no-retina> </div>
                        </div>
                        ...
                        <div class="tp-caption   tp-resizeme rs-parallaxlevel-12"
                            ...
                            <div class="rs-looped rs-wave"  data-speed="6" data-angle="0" data-radius="6px" data-origin="50% 50%">
                                <img src="{{ asset('assets/images/object/OBJ_triangle.png') }}" alt="" data-ww="['110px','110px','110px','110px']" data-hh="['95px','95px','95px','95px']" width="221" height="191" data-no-retina>
                            </div>
                        </div>
		...
		<div class="row">
			<div class="col-md-8 centerize-col">
				<div id="dynamicForm" class="mt-20" style="display: none;">
					...
					<input type="text" id="titleTextInput967" class="form-control md-input mt-10" placeholder="タイトル">
					<!-- Textarea input for We Design Digital Brand Experiences -->
					<textarea id="contentTextInput967" class="form-control md-textarea mt-10" placeholder="内容"></textarea>
					<!-- File input for changing background image -->
					<input type="file" id="fileInput967" class="form-control mt-10" accept="image/*">
				</div>
			</div>
		</div>
	</div>
	...
	<script>
        ...
        document.getElementById('titleTextInput967').addEventListener('input', function () {
            document.getElementById('slide-967-layer-2').innerHTML = this.value;
        });

        // Update the Brand Experiences text in real-time
        document.getElementById('contentTextInput967').addEventListener('input', function () {
            document.getElementById('slide-967-layer-3').innerText = this.value;
        });

        // Update the background image dynamically by changing the data-parallax-bg-image attribute
        document.getElementById('fileInput967').addEventListener('change', function (event) {
            const file = event.target.files[0];
            if (file) {
                const reader = new FileReader();
                reader.onload = function (e) {
                    // Find the correct tp-bgimg div using the data-index attribute of the slide
                    const slideBgImageElement = document.getElementById('imageFile967');
