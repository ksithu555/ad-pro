      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 section-heading">
              <form id="search-form" action="{{ route('admin.get.news') }}" method="GET">
        ...
        <div class="row mt-10">
                ...
                <tbody>
                  ...
                  <div id="modal-popup-{{ $new->id }}" class="white-bg all-padding-60 mfp-with-anim mfp-hide centerize-col col-lg-4 col-md-6 col-sm-7 col-xs-11 text-center">
                    ...
                    <p class="mb-20">新着情報を削除してもよろしいですか?</p>
                      <a class="btn btn-lg btn-circle btn-color" href="{{ route('admin.delete.news', $new->id) }}">はい</a>
          ...
          @if ($news->isEmpty())
          <h1 class="mt-120 mb-60 text-center">新着情報はありません</h1>
          @endif
        </div>
      </div>
    </section>
