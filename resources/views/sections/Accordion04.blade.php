                    ...
                    <div class="panel-group accordion-style-04" id="accordion-style-4">
                        <div class="panel">
                            <div class="panel-heading"> 
                                <a data-toggle="collapse" data-parent="#accordion-style" href="#style1" aria-expanded="false" class="collapsed">
                                <div id="titleText1" class="panel-title text-uppercase">
                                    Can I customize the fonts? 
                                    <span class="pull-right"><i class="ion-chevron-up"></i></span> 
                                </div>
                                </a> 
                            </div>
                            <div id="style1" class="panel-collapse collapse in" aria-expanded="false" role="tablist">
                        ...
                        <div class="panel">
                            <div class="panel-heading"> 
                                <a data-toggle="collapse" data-parent="#accordion-style" href="#style2" aria-expanded="false" class="collapsed">
                                <div id="titleText2" class="panel-title text-uppercase">
                                    What about blog options? 
                                    <span class="pull-right"><i class="ion-chevron-down"></i></span> 
                                </div>
                                </a> 
                            </div>
                            <div id="style2" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                        ...
                        <div class="panel">
                            <div class="panel-heading"> 
                                <a data-toggle="collapse" data-parent="#accordion-style" href="#style3" aria-expanded="false" class="collapsed">
                                <div id="titleText3" class="panel-title text-uppercase">
                                    Is this template Responsive? 
                                    <span class="pull-right"><i class="ion-chevron-down"></i></span> 
                                </div>
                                </a> 
                            </div>
                            <div id="style3" class="panel-collapse collapse" aria-expanded="false" role="tablist">
                        ...
                        <div class="panel">
                            <div class="panel-heading"> 
                                <a data-toggle="collapse" data-parent="#accordion-style" href="#style4" aria-expanded="false" class="collapsed">
                                <div id="titleText4" class="panel-title text-uppercase">
                                    We're ready to start now? 
                                    <span class="pull-right"><i class="ion-chevron-down"></i></span> 
                                </div>
                                </a> 
                            </div>
                            <div id="style4" class="panel-collapse collapse" aria-expanded="false" role="tablist">
