<x-section-layout>
            ...
            <div id="rev_slider_1061_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                <ul>    <!-- SLIDE  -->
                    <li data-index="rs-2978" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="assets/images/slides/home-bg-33-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Development" data-param1="01" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img id="slide-2978-image" src="{{ asset('assets/images/title-bg/ad-pro-default.jpg') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgparallax="3" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        <!-- LAYER NR. 1 -->
                    ...
                    <li data-index="rs-2979" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="assets/images/slides/home-bg-34-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Quality" data-param1="02" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img id="slide-2979-image" src="{{ asset('assets/images/title-bg/ad-pro-default.jpg') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="3" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                    ...
                    <li data-index="rs-2980" data-transition="fadethroughdark" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="assets/images/slides/home-bg-35-100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Classic" data-param1="03" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                        <!-- MAIN IMAGE -->
                        <img id="slide-2980-image" src="{{ asset('assets/images/title-bg/ad-pro-default.jpg') }}"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="3" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption Creative-Title   tp-resizeme rs-parallaxlevel-1"
                            ...
                            style="z-index: 20; white-space: nowrap;text-transform:left;">
                            Innovative<br/>
                            Technology 
                        </div>
        ...
        <div class="row">
            <div class="col-md-8 centerize-col">
                <div id="dynamicForm" class="mt-20" style="display: none;">
                    ...
                    <input type="text" id="titleTextInput2978" class="form-control md-input mt-10" placeholder="タイトル">
                    <!-- Textarea input for We Design Digital Brand Experiences -->
                    <textarea id="contentTextInput2978" class="form-control md-textarea mt-10" placeholder="内容"></textarea>
                    <!-- File input for changing background image -->
                    <input type="file" id="fileInput2978" class="form-control mt-10" accept="image/*">


                    <!-- Text input for Design Studio -->
                    <h4>ブロック２</h4>
                    <input type="text" id="titleTextInput2979" class="form-control md-input mt-10" placeholder="タイトル">
                    <!-- Textarea input for We Design Digital Brand Experiences -->
                    <textarea id="contentTextInput2979" class="form-control md-textarea mt-10" placeholder="内容"></textarea>
                    <!-- File input for changing background image -->
                    <input type="file" id="fileInput2979" class="form-control mt-10" accept="image/*">


                    <!-- Text input for Design Studio -->
                    <h4>ブロック３</h4>
                    <input type="text" id="titleTextInput2980" class="form-control md-input mt-10" placeholder="タイトル">
                    <!-- Textarea input for We Design Digital Brand Experiences -->
                    <textarea id="contentTextInput2980" class="form-control md-textarea mt-10" placeholder="内容"></textarea>
                    <!-- File input for changing background image -->
                    <input type="file" id="fileInput2980" class="form-control mt-10" accept="image/*">
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('titleTextInput2978').addEventListener('input', function () {
            document.getElementById('slide-2978-layer-3').innerText = this.value;
            // Update the title inside the tab ('.tp-tab-title')
            const tabTitleElement = document.querySelector('div[data-liref="rs-2978"] .tp-tab-title');
            if (tabTitleElement) {
                tabTitleElement.innerText = this.value;
            } else {
                console.error('Tab title element not found for rs-2978.');
            }
        });

        // Update the Brand Experiences text in real-time
        document.getElementById('contentTextInput2978').addEventListener('input', function () {
            document.getElementById('slide-2978-layer-2').innerText = this.value;
        });

        // Update the background image dynamically by changing the data-parallax-bg-image attribute
        document.getElementById('fileInput2978').addEventListener('change', function (event) {
            const file = event.target.files[0];
            if (file) {
                const reader = new FileReader();
                reader.onload = function (e) {
                    // Find the correct tp-bgimg div using the data-index attribute of the slide
                    const slideBgImageElement = document.querySelector('li[data-index="rs-2978"] .tp-bgimg');
        ...
        // Update the Design Studio heading in real-time
        document.getElementById('titleTextInput2979').addEventListener('input', function () {
            document.getElementById('slide-2979-layer-3').innerText = this.value;
            // Update the title inside the tab ('.tp-tab-title')
            const tabTitleElement = document.querySelector('div[data-liref="rs-2979"] .tp-tab-title');
            if (tabTitleElement) {
                tabTitleElement.innerText = this.value;
            } else {
                console.error('Tab title element not found for rs-2979.');
            }
        });

        // Update the Brand Experiences text in real-time
        document.getElementById('contentTextInput2979').addEventListener('input', function () {
            document.getElementById('slide-2979-layer-2').innerText = this.value;
        });

        // Update the background image dynamically by changing the data-parallax-bg-image attribute
        document.getElementById('fileInput2979').addEventListener('change', function (event) {
            const file = event.target.files[0];
            if (file) {
                const reader = new FileReader();
                reader.onload = function (e) {
                    // Find the correct tp-bgimg div using the data-index attribute of the slide
                    const slideBgImageElement = document.querySelector('li[data-index="rs-2979"] .tp-bgimg');
                    if (slideBgImageElement) {
                        // Update the background image style
                        slideBgImageElement.style.backgroundImage = `url(${e.target.result})`;
                    } else {
        ...
        // Update the Design Studio heading in real-time
        document.getElementById('titleTextInput2980').addEventListener('input', function () {
            document.getElementById('slide-2980-layer-3').innerText = this.value;
            // Update the title inside the tab ('.tp-tab-title')
            const tabTitleElement = document.querySelector('div[data-liref="rs-2980"] .tp-tab-title');
            if (tabTitleElement) {
                tabTitleElement.innerText = this.value;
            } else {
                console.error('Tab title element not found for rs-2980.');
            }
        });

        // Update the Brand Experiences text in real-time
        document.getElementById('contentTextInput2980').addEventListener('input', function () {
            document.getElementById('slide-2980-layer-2').innerText = this.value;
        });

        // Update the background image dynamically by changing the data-parallax-bg-image attribute
        document.getElementById('fileInput2980').addEventListener('change', function (event) {
            const file = event.target.files[0];
            if (file) {
                const reader = new FileReader();
                reader.onload = function (e) {
                    // Find the correct tp-bgimg div using the data-index attribute of the slide
                    const slideBgImageElement = document.querySelector('li[data-index="rs-2980"] .tp-bgimg');
                    if (slideBgImageElement) {
                        // Update the background image style
                        slideBgImageElement.style.backgroundImage = `url(${e.target.result})`;
                    } else {
