                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                            <div class="form-group">
                                ...
                                <input type="number" name="minBlock" class="md-input" id="minBlock" placeholder="最小ブロック *" value="{{ old('minBlock') ? old('minBlock') : $section->minBlock }}">
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                            <div class="form-group">
                                ...
                                <input type="number" name="maxBlock" class="md-input" id="maxBlock" placeholder="最大ブロック *" value="{{ old('maxBlock') ? old('maxBlock') : $section->maxBlock }}">
