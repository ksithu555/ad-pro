<x-admin-layout>
    ...
    <div class="container">
    	<div class="row">
        	<div class="col-sm-8 section-heading">
              <h4 class="text-uppercase mt-0">お知らせ修正</h4>
        	</div>
        </div>
        <div class="row mt-50">
            <div class="col-md-12">
              <form name="edit-notice-form" id="edit-notice-form" action="{{ route('admin.update.notice') }}" method="POST" 
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                      <div class="form-group">
                          ...
                          <textarea name="body" class="md-textarea" id="body" rows="7" placeholder="内容 *">{{ old('body') ? old('body') : $notice->body }}</textarea>
  ...
  <script>
    ...
    function submitForm() {
        ...
        document.getElementById('edit-notice-form').submit();
    }
