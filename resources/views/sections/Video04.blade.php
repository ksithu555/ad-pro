...
<section class="white-bg">
  <div class="container">
    <div class="row">
        <div class="col-md-6">
          <div class="video-box"> <img id="imageFile" class="img-responsive" src="{{ asset('assets/images/title-bg/ad-pro-default.jpg') }}" alt="">
        ...
        <div class="col-md-6 parallax-content">
            ...
            <p id="contentText" class="mt-30 font-16px dark-color roboto-font">Whether you're building a simple prototype or a business-critical product, And We have Developers, designers, and happy clients.</p>
        </div>
      </div>
  </div>
</section>
