<x-user-layout>
    ...
    <section class="white-bg pt-120 pb-120">
        <div class="container">
            <div class="row">
                ...
                <h4 class="text-uppercase mt-0">画像ブロック登録</h4>
                </div>
            </div>
            <div class="row mt-50">
                <div class="col-md-12">
                    <form name="add-image-block-form" id="add-image-block-form" action="{{ route('user.store.image.block') }}" method="POST" 
    ...
    <div id="modal-popup" class="white-bg all-padding-60 mfp-with-anim mfp-hide centerize-col col-lg-4 col-md-6 col-sm-7 col-xs-11 text-center">
        <span class="text-uppercase font-30px font-600 mb-20 display-block dark-color">画像ブロック登録</span>
        <p class="mb-20">画像ブロックを登録してもよろしいですか?</p>
    ...
    <script>
        ...
        function submitForm() {
            ...
            document.getElementById('add-image-block-form').submit();
        }

        function validateAddimageBlockForm() {
            let isValid = true;
