                        ...
                        <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                            <div class="form-group">
                                <select name="requiredPlan" class="orderby type md-input">
                                    <option value="1" @if($section->required_plan == '1')selected="selected"@endif>シルバー</option>
                                    <option value="2" @if($section->required_plan == '2')selected="selected"@endif>ゴールド</option>
                                </select>
                                <span class="error" style="color:#BF0731" id="error-type"></span>
                            </div>
                        </div>
