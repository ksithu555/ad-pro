            ...
            <div class="row mt-50">
                <div class="col-md-12">
                    <form name="edit-sub-box-block-form" id="edit-sub-box-block-form" action="{{ route('user.update.sub.box.block') }}" method="POST" 
                        ...
                        $subBoxBlock->advertisementBoxBlock->advertisementSection->section->name == 'Box06' ||
                        $subBoxBlock->advertisementBoxBlock->advertisementSection->section->name == 'Box07' ||
                        $subBoxBlock->advertisementBoxBlock->advertisementSection->section->name == 'Box08')
                        <div class="row">
                            <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                                <div class="form-group">
                                    <div class="info-icon-container">
