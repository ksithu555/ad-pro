...
<div class="wrapper">
    ...
    @foreach ($advertisementSections as $advertisementSection)
        ...
        {{-- Header Hero Start --}}
                                    ...
                                    <div class="row">
                                        <div class="col-md-10 centerize-col">
                                            <div class="white-color text-center">
                                                ...
                                                <h1 class="white-color font-700 font-100px line-height-120 xs-font-40px xs-line-height-50 sm-font-60px sm-line-height-60 play-font wow fadeInUp" 
                                                    data-wow-delay="0.2s">
                    ...
                    <ul>    <!-- SLIDE  -->
                        ...
                        <li data-index="rs-{{ 2978 + $loopindex }}" data-transition="fadethroughdark" data-slotamount="default" 
                            ...
                            <div class="tp-caption Creative-Title   tp-resizeme rs-parallaxlevel-1"
                                ...
                                data-fontsize="['70','50','30','20']"
                                data-lineheight="['50','35','35','25']"
                                data-width="['1200','800','600','320']"
                                data-height="none"
                                                ...
                                                <div class="tp-caption  "
                                                    ...
                                                    <div class="tp-caption  "
                                                        ...
                                                        <div class="tp-caption   tp-resizeme  blurslider-gradient"
                                                            ...
                                                            data-fontsize="['100','90','70','30']"
                                                            data-lineheight="['100','90','80','70']"
                                                            data-width="['1000','800','700','360']"
                                                            data-height="none"
            ...
            <!--== Header09 End ==-->
            @elseif ($advertisementSection->section->name == 'Header10')
            <!--== Header10 Start ==-->
            <section class="{{ $sectionBg }} remove-padding transition-none" id="{{ $advertisementSection->name }}">
                @foreach ($advertisementSection->advertisementHeaderBlocks as $advertisementHeaderBlock)
                @if ($advertisementHeaderBlock->status == 1)
                        ...
                        <ul>	<!-- SLIDE  -->
                            <li data-index="rs-967" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                ...
                                <div class="tp-caption   tp-resizeme rs-parallaxlevel-2"
                                    ...
                                    style="z-index: 13; color: #ffffff; font-family:Poppins;">
                                    {{ $advertisementHeaderBlock->title }}
                                </div>
        ...
        {{-- Video Hero Start --}}
            ...
            <!--== Video03 End ==-->
            @elseif ($advertisementSection->section->name == 'Video04')
            <!--== Video04 Start ==-->
            <section class="{{ $sectionBg }} pt-50 pb-50" id="{{ $advertisementSection->name }}">
                <div class="container">
                    @foreach ($advertisementSection->advertisementVideoBlocks as $key => $advertisementVideoBlock)
            ...
            <!--== Video04 End ==-->
            @elseif ($advertisementSection->section->name == 'Video05')
            <!--== Video05 Start ==-->
            <section class="{{ $sectionBg }} pt-0 pb-0" id="{{ $advertisementSection->name }}">
                @foreach ($advertisementSection->advertisementVideoBlocks as $key => $advertisementVideoBlock)
                    @if ($advertisementVideoBlock->status == 1)
                    <section class="parallax-bg fixed-bg" data-parallax-bg-image="{{ asset('assets/images/all/' . $advertisementVideoBlock->image) }}" 
                                ...
                                <div class="col-md-10 col-md-offset-1 text-center parallax-content">
                                    <div class="center-layout">
                                        <div class="v-align-middle">
                                            ...
                                            <h4 class="text-uppercase mt-10 font-700 roboto-font white-color">{{ $advertisementVideoBlock->title }}</h4>
                                            <hr class="left_line default-bg">
                                            <p class="font-16px roboto-font white-color mt-30">{!! nl2br($advertisementVideoBlock->body) !!}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    var revapi4;
    tpj(document).ready(function() {
        // Check if the slider element exists in the DOM
        if(tpj("#rev_slider_4_1").length > 0) {
