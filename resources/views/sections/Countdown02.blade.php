<x-section-layout>
    <!--== Who We Are Start ==-->
    <section class="default-bg pt-50 pb-50">
        <div class="row">
                ...
                <div class="countdown-container mt-0 mb-0">
                    <ul class="countdown">
                        <li class="white-color">
                            <span class="days font-80px font-400" id="days">0</span>
                            <p class="dark-color text-uppercase">days</p>
                        </li>
                        <li class="white-color">
                            <span class="hours font-80px font-400" id="hours">0</span>
                            <p class="dark-color text-uppercase">hours</p>
                        </li>
                        <li class="white-color">
                            <span class="minutes font-80px font-400" id="minutes">0</span>
                            <p class="dark-color text-uppercase">minutes</p>
                        </li>
                        <li class="white-color">
                            <span class="seconds font-80px font-400" id="seconds">0</span>
