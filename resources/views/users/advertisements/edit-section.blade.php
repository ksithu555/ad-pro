<x-user-layout>
    ...
    <section class="white-bg pt-120 pb-120">
        <div class="container">
            ...
            <div class="row mt-50">
                <div class="col-md-12">
                <form name="edit-section-form" id="edit-section-form" action="{{ route('user.update.section') }}" method="POST" 
                    class="contact-form-style-01" enctype="multipart/form-data">
                    @csrf
                    <div class="messages"></div>
                    <input type="hidden" id="id" name="id" value="{{ $advertisementSection->id }}">
                    <div class="row">
                        <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                            <div class="form-group">
                                <label class="sr-only" for="name">名前</label>
                                <input type="text" name="name" class="md-input" id="name" placeholder="名前 *" value="{{ old('name') ? old('name') : $advertisementSection->name }}">
