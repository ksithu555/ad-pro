              ...
              <div class="col-lg-8 col-md-6 col-sm-6 col-xs-12 display-table" style="height:30px;">
               ...
               <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12 display-table text-right text-xs-left xs-mt-10">
                   <div class="v-align-middle text-right text-xs-center">
                      <h1 class="text-uppercase mb-0 font-600 font-20px line-height-26 mt-0">ログイン</h1>
                  </div>
               </div>
             </div>
          </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 section-heading">
                    <h4 class="text-uppercase mt-0">ログイン</h4>
                    <x-message-box></x-message-box>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8 centerize-col">
                    <form name="login-form" id="login-form" action="{{ route('user.store.login') }}" method="POST" class="contact-form-style-01">
                        @csrf
