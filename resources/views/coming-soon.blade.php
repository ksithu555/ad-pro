  ...
  <section class="remove-padding transition-none">
    ...
    <ul>	<!-- SLIDE  -->
    	<li data-index="rs-414" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
    		<!-- MAIN IMAGE -->
    		<img src="{{ asset('assets/images/title-bg/comingsoon-bg.jpg') }}"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="20000" data-ease="Linear.easeNone" data-scalestart="130" data-scaleend="100" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
    		<!-- LAYERS -->
    		...
    		<div class="tp-caption   tp-resizeme"
    			...
    			style="z-index: 8; min-width: 300px; max-width: 300px; white-space: nowrap; 
    		...
    		<div class="tp-caption   tp-resizeme"
    			...
    			style="z-index: 10; min-width: 300px; max-width: 300px; white-space: nowrap; 
                font-size: 200px; line-height: 500px; font-weight: 600; color: rgba(191, 7, 49, 1.00);
                font-family: 'Roboto', sans-serif;letter-spacing:-5px;"
    			id="t_minutes">00 </div>
    		...
    		<div class="tp-caption   tp-resizeme"
    			...
    			style="z-index: 11; min-width: 300px; max-width: 300px; white-space: nowrap; 
                font-size: 200px; line-height: 500px; font-weight: 600; color: rgba(191, 7, 49, 1.00);
                font-family: 'Roboto', sans-serif;letter-spacing:-5px;"
    			id="t_seconds">00 </div>
    		...
    		<div class="tp-caption   tp-resizeme"
    			...
    			style="z-index: 12; min-width: 300px; max-width: 300px; white-space: nowrap; 
                font-size: 25px; line-height: 350px; font-weight: 600; color: rgba(255, 255, 255, 1.00);
                font-family: 'Roboto', sans-serif;">DAYS </div>
    		...
    		<div class="tp-caption   tp-resizeme"
    			...
    			style="z-index: 13; min-width: 300px; max-width: 300px; white-space: nowrap; 
                font-size: 25px; line-height: 350px; font-weight: 600; color: rgba(255, 255, 255, 1.00);
                font-family: 'Roboto', sans-serif;">HOURS </div>
    		...
    		<div class="tp-caption   tp-resizeme"
    			...
    			style="z-index: 14; min-width: 300px; max-width: 300px; white-space: nowrap; 
                font-size: 25px; line-height: 350px; font-weight: 600; color: rgba(255, 255, 255, 1.00);
                font-family: 'Roboto', sans-serif;">MINUTES </div>
    		...
    		<div class="tp-caption   tp-resizeme"
    			...
    			style="z-index: 15; min-width: 300px; max-width: 300px; white-space: nowrap; 
                font-size: 25px; line-height: 350px; font-weight: 600; color: rgba(255, 255, 255, 1.00);
                font-family: 'Roboto', sans-serif;">SECONDS </div>
    	</li>
    </ul>
