    ...
    <section class="dark-bg">
        <div class="container">
            <div class="row">
                ...
                <h4 class="text-uppercase mt-0">Accordion Style 02</h4>
                </div>
            </div>
            <div class="row mt-50">
                    ...
                    <div class="panel-group accordion-style-02" id="accordion-style-02">
                        <div class="panel">
                            <div class="panel-heading"> <a data-toggle="collapse" data-parent="#accordion-style" href="#dark1" aria-expanded="false" class="collapsed">
                                <div class="panel-title text-uppercase white-color">Can I customize the fonts? <span class="pull-right"><i class="ion-android-remove"></i></span> </div>
                                </a> </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading"> <a data-toggle="collapse" data-parent="#accordion-style" href="#dark2" aria-expanded="false" class="collapsed">
                                <div class="panel-title text-uppercase white-color">What about blog options? <span class="pull-right"><i class="ion-android-add"></i></span> </div>
                                </a> </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading"> <a data-toggle="collapse" data-parent="#accordion-style" href="#dark3" aria-expanded="false" class="collapsed">
                                <div class="panel-title text-uppercase white-color">Is this template Responsive? <span class="pull-right"><i class="ion-android-add"></i></span> </div>
                                </a> </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading"> <a data-toggle="collapse" data-parent="#accordion-style" href="#dark4" aria-expanded="false" class="collapsed">
                                <div class="panel-title text-uppercase white-color">We're ready to start now? <span class="pull-right"><i class="ion-android-add"></i></span> </div>
                                </a> </div>
