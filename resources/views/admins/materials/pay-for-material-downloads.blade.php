<x-admin-layout>
                    ...
                    <div style="display: flex; justify-content: flex-end; align-items: center; gap: 10px;">
                        <div class="tr-modal-popup">
                            ...
                            onclick="showModal()" id="open-modal">
                                <i class="ion-cash"></i> 支払う
                            </a>
                        </div>
                        <a class="btn btn-md btn-dark-outline btn-square margin-left-auto margin-right-auto display-table-sm"
                        href="{{ route('admin.paid.user.for.material.downloads', $id) }}">
                            支払済み <i class="ion-android-arrow-forward"></i>
                        </a>
                    </div>                    
                </div>
            </div>
            ...
            <div class="row mt-10">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <form action="{{ route('admin.pay.user.for.selected.material.downloads') }}" method="POST" id="paymentForm">
                            @csrf
    ...
    <div id="modal-popup" class="white-bg all-padding-60 mfp-with-anim mfp-hide centerize-col col-lg-4 col-md-6 col-sm-7 col-xs-11 text-center">
        <span class="text-uppercase font-30px font-600 mb-20 display-block dark-color">支払う</span>
        <p class="mb-20">選択されたものは支払っててもよろしいですか?</p>
