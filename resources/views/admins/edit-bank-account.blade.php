<x-admin-layout>
    ...
    <div class="container">
    	<div class="row">
        	<div class="col-sm-8 section-heading">
              <h4 class="text-uppercase mt-0">銀行口座修正</h4>
        	</div>
        </div>
        <div class="row mt-50">
            <div class="col-md-12">
              <form name="edit-bank-account-form" id="edit-bank-account-form" action="{{ route('admin.update.bank.account') }}" method="POST" 
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="bankName" class="md-input" id="bankName" placeholder="銀行名 *" value="{{ old('bankName') ? old('bankName') : $bankAccount->bank_name }}">
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="branchName" class="md-input" id="branchName" placeholder="支店名 *" value="{{ old('branchName') ? old('branchName') : $bankAccount->branch_name }}">
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="accountType" class="md-input" id="accountType" placeholder="口座種別 *" value="{{ old('accountType') ? old('accountType') : $bankAccount->account_type }}">
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="accountNumber" class="md-input" id="accountNumber" placeholder="口座番号 *" value="{{ old('accountNumber') ? old('accountNumber') : $bankAccount->account_number }}">
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="accountName" class="md-input" id="accountName" placeholder="口座名 *" value="{{ old('accountName') ? old('accountName') : $bankAccount->account_name }}">
  ...
  <div id="modal-popup" class="white-bg all-padding-60 mfp-with-anim mfp-hide centerize-col col-lg-4 col-md-6 col-sm-7 col-xs-11 text-center">
    ...
    <a class="btn btn-lg btn-circle btn-secondary-color popup-modal-close" href="#">いいえs</a>
  </div>
  ...
  <script>
    ...
    function submitForm() {
        ...
        document.getElementById('edit-bank-account-form').submit();
    }
