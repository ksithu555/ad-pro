<x-guest-layout>
    ...
    <div class="transition-none">
        <section class="title-hero-bg parallax-effect" style="background-image: url({{ asset('assets/images/title-bg/top-faq-bg.jpg') }});">
            <div class="container">
                    ...
                    <div class="panel-group accordion-style-03" id="accordion-style-03">
                        <div class="panel">
                            <div class="panel-heading"> <a data-toggle="collapse" data-parent="#accordion-style" href="#light1" aria-expanded="false" class="collapsed">
                                <div class="panel-title text-uppercase white-color">Can I customize the fonts? <span class="pull-right"><i class="ion-chevron-up"></i></span> </div>
                                </a> 
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading"> <a data-toggle="collapse" data-parent="#accordion-style" href="#light2" aria-expanded="false" class="collapsed">
                                <div class="panel-title text-uppercase white-color">What about blog options? <span class="pull-right"><i class="ion-chevron-down"></i></span> </div>
                                </a> 
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading"> <a data-toggle="collapse" data-parent="#accordion-style" href="#light3" aria-expanded="false" class="collapsed">
                                <div class="panel-title text-uppercase white-color">Is this template Responsive? <span class="pull-right"><i class="ion-chevron-down"></i></span> </div>
                                </a> 
                            </div>
                        ...
                        <div class="panel">
                            <div class="panel-heading"> <a data-toggle="collapse" data-parent="#accordion-style" href="#light4" aria-expanded="false" class="collapsed">
                                <div class="panel-title text-uppercase white-color">We're ready to start now? <span class="pull-right"><i class="ion-chevron-down"></i></span> </div>
                                </a> 
                            </div>
