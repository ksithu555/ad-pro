<x-admin-layout>
    ...
    <section class="white-bg pt-120 pb-120">
        <div class="container">
            <div class="row">
                ...
                <h4 class="text-uppercase mt-0">管理者修正</h4>
                </div>
            </div>
            <div class="row mt-50">
                <div class="col-md-12">
                    <form name="edit-sub-admin-form" id="edit-sub-admin-form" action="{{ route('admin.update.sub.admin') }}" 
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-sm-8 col-md-offset-2 col-sd-offset-2 pt-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="md-input" id="name" placeholder="名前 *" value="{{ old('name') ? old('name') : $subAdmin->name }}">
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-sm-8 col-md-offset-2 col-sd-offset-2 pt-10">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email" class="md-input" id="email" placeholder="メール *"value="{{ old('email') ? old('email') : $subAdmin->email }}">
    ...
    <div id="modal-popup" class="white-bg all-padding-60 mfp-with-anim mfp-hide centerize-col col-lg-4 col-md-6 col-sm-7 col-xs-11 text-center">
        <span class="text-uppercase font-30px font-600 mb-20 display-block dark-color">管理者修正</span>
        <p class="mb-20">管理者を修正してもよろしいですか?</p>
    ...
    <script>
        ...
        function submitForm() {
            ...
            document.getElementById('edit-sub-admin-form').submit();
        }
